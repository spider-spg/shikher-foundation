...
const EditBook = () => {
  ...
  const fetchBook = async () => {
    if (!id) { toast.error('Book ID is required'); navigate('/admin/books'); return; }
    try {
      setLoading(true);
      ...
      if (book.imageData || book.image) setImagePreview(book.imageData || book.image);
    } catch (error) {
          ...
          <form onSubmit={handleSubmit} className="p-8 space-y-8">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Shelf Location <span className="text-gray-400 font-normal">(Optional)</span></label>
              ...
              <div className="flex items-start space-x-6">
                ...
                <div className="flex-1">
                  ...
                  <label htmlFor="image"
                    ...
                    <FaUpload className="mr-2" /> {imagePreview ? 'Change Image' : 'Upload Image'}
                  </label>
